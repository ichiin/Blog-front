    ...
    render() {
        return (
            <Grid container direction={'column'} alignItems={'center'} justify={'center'}>
                <Grid id={'header'} container direction={'column'} alignItems={'center'} justify={'center'}
                      style={{height: '30vh'}}>
                        ...
                        return (
                            <Grid item xs={8} style={{marginBottom: 15}}>
                                <Link to={`/${doc.post_title.replace(/ /g, '-')}`}>
                                    <div id={"cardbg"}>
                                        <div id={"carddark"}>
                                            <Grid container direction={'column'} style={{padding: 20, height: 265}}>
                                                ...
                                                <Grid container alignItems={'flex-end'} justify={'center'}
                                                    ...
                                                    <Grid container direction={'row'} justify={"center"}
                                                          alignItems={"center"}>
                                                        <Grid item xs={7}>
                                                            <div className={'blog_post_body'} style={{
                                                                maxHeight: "105px",
                                                                overflowY: "hidden",
                                                                overflowX: "hidden"
                                                            }}>{doc.post_body}</div>
                                                        </Grid>
                                                        {doc.post_imgURL && doc.post_imgURL.length > 0 &&
                                                        <Grid item xs={5}>
                                                            <Grid container justify={"center"} direction={"row"}>
                                                                <img src={doc.post_imgURL} alt={"lul"} style={{
                                                                    height: "100px",
                                                                    width: "100px",
                                                                    borderRadius: "50%",
